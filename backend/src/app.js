...
const pitchRehearsalRoutes = require('./routes/pitchRehearsal');
const pollsRoutes = require('./routes/polls');
const peerReviewsRoutes = require('./routes/peerReviews');
...
app.use('/api/pitchRehearsal', pitchRehearsalRoutes);
app.use('/api/polls', pollsRoutes);
app.use('/api/peerReviews', peerReviewsRoutes);
