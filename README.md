...
A full-stack, AI-powered hackathon management system that is built using the MERN stack. HackForge automates the entire event lifecycle — from intelligent participant registration to real-time bias detection and automated result publishing.
